...
class Example {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Activity activity =
        Activity.builder().actor("User:1").verb("pin").object("Place:42").target("Board:1").build();
    ...
    response =
        userFeed
            .getActivities(new Filter().idLessThan("e561de8f-00f1-11e4-b400-0cc47a024be0").limit(5))
            .join();
    ...
    List<FollowRelation> followers =
        userFeed.getFollowers(new Pagination().offset(0).limit(10)).join();
    ...
    List<FollowRelation> followed =
        userFeed.getFollowed(new Pagination().offset(0).limit(10)).join();
    ...
    followed =
        userFeed
            .getFollowed(
                new Pagination().offset(0).limit(2),
                new FeedID("user:42"),
                new FeedID("user", "43"))
            .join();
    ...
    List<NotificationGroup<Activity>> activityGroups =
        notifications.getActivities(new ActivityMarker().allSeen()).join();
    ...
    activityGroups =
        notifications
            .getActivities(new ActivityMarker().read("groupID1", "groupID2" /* ... */))
            .join();
    ...
    activity =
        Activity.builder().actor("User:2").verb("pin").object("Place:42").target("Board:1").build();
    FeedID[] feeds =
        new FeedID[] {
    ...
    client
        .batch()
        .getActivitiesByID(
            "01b3c1dd-e7ab-4649-b5b3-b4371d8f7045", "ed2837a6-0a3b-4679-adc1-778a1704852");

    // retrieve an activity by foreign ID and time
    client
        .batch()
        .getActivitiesByForeignID(
            new ForeignIDTimePair("foreignID1", new Date()),
    ...
    client
        .reactions()
        .add("john-doe", Reaction.builder().kind("like").activityID(activity.getID()).build());
    ...
    List<Reaction> reactions =
        client
            .reactions()
            .filter(LookupKind.ACTIVITY, "ed2837a6-0a3b-4679-adc1-778a1704852d")
            .join();
    ...
    Reaction reaction =
        client
            .reactions()
            .addChild("john-doe", comment.getId(), Reaction.builder().kind("like").build())
            .join();
    ...
    client
        .reactions()
        .update(Reaction.builder().id(reaction.getId()).extraField("text", "love it!").build());
    ...
    client
        .collections()
        .add("food", new CollectionData().set("name", "Cheese Burger").set("rating", "4 stars"));
    ...
    client
        .flatFeed("user", "john")
        .addActivity(
            Activity.builder().actor(johnDoeRef).verb("eat").object(cheeseBurgerRef).build());
