...
public class CollectionsClientTest {
  ...
  public void add() throws Exception {
    ...
    CollectionData data =
        new CollectionData().set("key", "value").set("extra", ImmutableMap.of("test", "test"));
  ...
  public void update() throws Exception {
    ...
    CollectionData otherData =
        new CollectionData(data.getID())
            .set("key", "other_value")
  ...
  public void upsertMany() throws Exception {
    ...
    CollectionData data =
        new CollectionData("id_6")
            .set("key", "value")
            .set("extra", ImmutableMap.of("test", "test"));
    CollectionData custom =
  ...
  public void getCustom() throws Exception {
    ...
    CustomType result =
        client.getCustom(CustomType.class, "get_custom_collection", data.getID()).join();
  }
  ...
  public void getManyCustom() throws Exception {
    ...
    CollectionData data =
        new CollectionData("id_10")
            .set("key", "value")
            .set("extra", ImmutableMap.of("test", "test"));
    client.upsert("get_many_custom_collection", data).join();

    List<CustomType> result =
        client.selectCustom(CustomType.class, "get_many_custom_collection", "id_10").join();
  }
