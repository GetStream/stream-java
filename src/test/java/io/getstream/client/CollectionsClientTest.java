...
public class CollectionsClientTest {
  ...
  public void addCustom() throws Exception {
    CollectionsClient client = Client.builder(apiKey, secret).build().collections();
  ...
  public void add() throws Exception {
    ...
    CollectionData data = new CollectionData().set("key", "value").set("extra", ImmutableMap.of("test", "test"));
  ...
  public void update() throws Exception {
    ...
    CollectionData otherData = new CollectionData(data.getID()).set("key", "other_value").set("extra",
        ImmutableMap.of("test", "other_test"));
  ...
  public void upsertMany() throws Exception {
    ...
    CollectionData data = new CollectionData("id_6").set("key", "value").set("extra", ImmutableMap.of("test", "test"));
  ...
  public void getManyCustom() throws Exception {
    ...
    CollectionData data = new CollectionData("id_10").set("key", "value").set("extra", ImmutableMap.of("test", "test"));
  ...
  public void getMany() throws Exception {
    ...
    CollectionData data = new CollectionData("id_11").set("key", "value").set("extra", ImmutableMap.of("test", "test"));
