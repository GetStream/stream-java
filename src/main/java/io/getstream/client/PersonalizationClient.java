...
public final class PersonalizationClient {
  ...
  public CompletableFuture<Map<String, Object>> get(String resource, Map<String, Object> params)
      throws StreamException {
    return get(null, resource, params);
  }

  public CompletableFuture<Map<String, Object>> get(String userID, String resource)
      throws StreamException {
    return get(userID, resource, ImmutableMap.of());
  }

  public CompletableFuture<Map<String, Object>> get(
      String userID, String resource, Map<String, Object> params) throws StreamException {
  ...
  public CompletableFuture<Void> post(String resource, Map<String, Object> payload)
      throws StreamException {
  ...
  public CompletableFuture<Void> post(String userID, String resource, Map<String, Object> payload)
      throws StreamException {
    return post(userID, resource, ImmutableMap.of(), payload);
  }

  public CompletableFuture<Void> post(
      String userID, String resource, Map<String, Object> params, Map<String, Object> payload)
      throws StreamException {
  ...
  public CompletableFuture<Void> delete(String resource, Map<String, Object> params)
      throws StreamException {
  ...
  public CompletableFuture<Void> delete(String userID, String resource, Map<String, Object> params)
      throws StreamException {
