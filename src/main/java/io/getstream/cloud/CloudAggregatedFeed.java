...
public class CloudAggregatedFeed extends CloudFeed {
    ...
    public CompletableFuture<? extends List<? extends Group<Activity>>> getActivities(Limit limit)
            throws StreamException {
        return getActivities(
                limit,
                DefaultOptions.DEFAULT_OFFSET,
    ...
    public CompletableFuture<? extends List<? extends Group<Activity>>> getActivities(Offset offset)
            throws StreamException {
        return getActivities(
                DefaultOptions.DEFAULT_LIMIT,
                offset,
    ...
    public CompletableFuture<? extends List<? extends Group<Activity>>> getActivities(Filter filter)
            throws StreamException {
        return getActivities(
                DefaultOptions.DEFAULT_LIMIT,
                DefaultOptions.DEFAULT_OFFSET,
    ...
    CompletableFuture<? extends List<? extends Group<Activity>>> getActivities(
    ...
    <T> CompletableFuture<? extends List<? extends Group<T>>> getCustomActivities(
    ...
    public CompletableFuture<? extends List<? extends Group<EnrichedActivity>>>
    ...
    <T> CompletableFuture<? extends List<? extends Group<T>>> getEnrichedCustomActivities(
            Class<T> type,
            Limit limit,
            Offset offset,
            Filter filter,
