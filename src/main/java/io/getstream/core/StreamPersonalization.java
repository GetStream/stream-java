...
public final class StreamPersonalization {
    ...
    public CompletableFuture<Void> post(Token token, String userID, String resource, Map<String, Object> params, Map<String, Object> payload) throws StreamException {
        checkNotNull(resource, "Resource can't be empty");
        checkArgument(!resource.isEmpty(), "Resource can't be empty");
        checkNotNull(params, "Missing params");
        ...
        try {
            final byte[] jsonPayload = toJSON(new Object() {
