...
public final class Auth {
    ...
    public static Token buildToTargetUpdateToken(String secret, FeedID feed, TokenAction action) {
        return buildBackendToken(secret, TokenResource.FEED_TARGETS, action, feed.getSlug() + feed.getUserID());
    }
    ...
    public static Token buildFollowToken(String secret, FeedID feed, TokenAction action) {
        return buildBackendToken(secret, TokenResource.FOLLOWER, action, feed.getSlug() + feed.getUserID());
    }
    ...
    public static Token buildPersonalizationToken(String secret, String userID, TokenAction action) {
        return buildBackendToken(secret, TokenResource.PERSONALIZATION, action, "*", firstNonNull(userID, "*"));
    }
