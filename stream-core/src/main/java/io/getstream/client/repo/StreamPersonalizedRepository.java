...
public interface StreamPersonalizedRepository {
     ...
     */
    <T extends PersonalizedActivity> List<T> get(PersonalizedFeed feed, Class<T> type) throws IOException, StreamClientException;

    /**
     * "Certain objects such as user profiles, product details etc. aren't part of the feeds. They can however be useful for personalization."<br/>
     * Use this method to sync this data to Stream.<br/>
    ...
    /**
     * Read the taste/ endpoint.<br/>
     * The response is deserialized by using Jackson, therefore Jackson's annotations and custom deserializers are honored.<br/>
